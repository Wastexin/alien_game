...
def update_bullets(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    check_bullet_alien_colisions(ai_settings,screen,stats,sb,ship,
                                 aliens,bullets)
...
def create_fleet(ai_settings,screen,ship,aliens,):
    ...
    alien = Aline(ai_settings, aliens)
...
def check_bullet_alien_colisions(ai_settings,screen,stats,sb,ship,
                                 aliens,bullets):
    #检查是否有子弹击中了外星人
    #如果是这样，就删除相应的子弹和外星人
